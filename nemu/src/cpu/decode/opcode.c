...
instr_func opcode_entry[256] = {
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, ljmp, jmp_short,
...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, adc_i2rm_b, inv, and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, or_i2rm_v, adc_i2rm_v, inv, and_i2rm_v, sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv, inv, and_i2rm_bv, sub_i2rm_bv, xor_i2rm_b, cmp_i2rm_bv};
...
instr_func group_x87_df_entry[8] =
    {inv, inv, inv, inv, x87_fnstsw, x87_fucomip, x87_fucomip, inv};
