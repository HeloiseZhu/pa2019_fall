...
BOOL PAL_IsPlayerPoisonedByLevel(
    WORD wPlayerRole,
    WORD wMinLevel)
/*++
  Purpose:
...
BOOL PAL_IsPlayerPoisonedByKind(
    WORD wPlayerRole,
    WORD wPoisonID)
/*++
  Purpose:
...
WORD PAL_GetPlayerMagicStrength(
    WORD wPlayerRole)
/*++
  Purpose:
...
WORD PAL_GetPlayerPoisonResistance(
    WORD wPlayerRole)
/*++
  Purpose:
...
WORD PAL_GetPlayerElementalResistance(
    WORD wPlayerRole,
    INT iAttrib)
/*++
  Purpose:
...
WORD PAL_GetPlayerBattleSprite(
    WORD wPlayerRole)
/*++
  Purpose:
...
WORD PAL_GetPlayerCooperativeMagic(
    WORD wPlayerRole)
/*++
  Purpose:
